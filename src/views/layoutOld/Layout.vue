<template>
    <div>
        <section class="page-header" :style="useBackgroundImage?'background:url('+backgroundImageUrl+') no-repeat center top':'background-image: linear-gradient(120deg, '+backgroundColorLeft+', '+backgroundColorRight+');color: '+fontColor+';'">
